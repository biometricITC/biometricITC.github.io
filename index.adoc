...
== Current Status
The BIO-iTC Public Review Draft 2 comment period has now been closed. The BIO-iTC is now reviewing the received comments.

The chart below shows the expected timeline for producing the final documents. More details are provided in the Public Review Draft 2 Overview document.
