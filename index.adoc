...
== Current Status
The BIO-iTC has publichsed the Eye, Face and Vein toolboxes on November 10, 2020. 

The iTC is currently reviewing the Fingerprint toolbox internally before releasing the first Public Review Draft.

The chart below shows the expected timeline for producing the final Fingerprint Toolbox documents. This will be updated again once work on the next update to the documentation starts.
