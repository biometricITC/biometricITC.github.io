...
== Current Status
While the BIO-iTC has closed the Public Review Draft 1 period, it has opened a short review period during the Update cycle specifically for a new mold material. This is being published as the Public Review Draft 1 - Moldable Plastics and will be open for 4 weeks.
