...
The BIO-iTC has published a Proposed Draft v1.2 of the PP-Module and Supporting Document. This update incorporates changes being made to the PAD Toolboxes to support additional attack levels
