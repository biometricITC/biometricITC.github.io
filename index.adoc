...
== Current Status
The BIO-iTC has posted Public Review Draft 1 of the PP-Module and Supporting Documents as of June 17, 2019. Comments for this round of Public Review will be accepted until July 31, 2019.
